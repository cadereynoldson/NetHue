...
public abstract class HueController
{
    ...
    public HueController(string configPath) : this(HueConfiguration.FromJson(configPath)) { }

    /// <summary>
    /// Creates a new instance of a HueController.
    /// </summary>
    /// <param name="config">The HueBridgeConfiguration to use.</param>
    public HueController(HueConfiguration config) : this(new HueRepository(config)) { }
